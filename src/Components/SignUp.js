...
const SignUp = () => {
  ...
  return (
    <div>
      <div className="flex flex-col w-full mx-auto max-w-md p-12 space-y-4 text-center dark:bg-gray-900 dark:text-gray-100">
        ...
        >
          <div className="flex flex-col">
            ...
            <input
              ...
              className="rounded-t-md my-5 focus:ring-violet-400 focus:dark:border-violet-400 focus:ring-2"
            />
